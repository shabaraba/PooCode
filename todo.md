...
- [ ] map演算子における関数ルックアップの問題修正(examples/fizzbuzz.pooが参考になる)
  - [ ] evalMapOperationとevalFilterOperationでの関数検索の診断ログ追加
  - [ ] マップ演算子およびフィルター演算子での関数ルックアップ処理の見直し
  - [ ] パイプライン演算子と関数ルックアップメカニズムの統一化
  - [ ] 関数検索時の環境変数スコープとコンテキスト検証
  - [ ] マップ演算子でも事前登録された関数が検索できることの確認
